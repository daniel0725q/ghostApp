...
class ExpendituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post expenditures_url, params: { expenditure: { group_id: @expenditure.group_id, name: @expenditure.name, user_id: @expenditure.user_id, value: @expenditure.value } }
    end
  ...
  test "should update expenditure" do
    patch expenditure_url(@expenditure), params: { expenditure: { group_id: @expenditure.group_id, name: @expenditure.name, user_id: @expenditure.user_id, value: @expenditure.value } }
