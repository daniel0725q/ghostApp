class ExpendituresController < ApplicationController
  ...
  def index
    @expenditures = Expenditure.where(user_id: current_user.id).sort_by{|expenditure| expenditure.date}.reverse
  end
  ...
  private
    ...
    def expenditure_params
      params.require(:expenditure).permit(:value, :name, :group_id, :date, :user_id)
    end
end
